...
public class Go extends JFrame {
    ...
    public Go() {
        ...
        prompt1JLabel = new JLabel("1-100 arasýnda sayým var tahmin et.");  
        add(prompt1JLabel);
        ...
        new ActionListener()  {
        	public void actionPerformed(ActionEvent e) {
        		...
        		tahmin--;
        		message2JLabel.setText("Oynanan oyun sayýsý: " + oyunsayisi);
        		oyunsayisi++;
        		tahmin=10;
        		}}
              );
    ...
    class GuessHandler implements ActionListener{    
        public void actionPerformed( ActionEvent e ){      
            ...
            getContentPane().setBackground(Color.RED);
            	if (Guess > number){
            		messageJLabel.setText( "Sayý yüksek." );
            		SwingUtilities.updateComponentTreeUI(messageJLabel);
            		tahmin--;}
             if(Guess < number){                          
                     messageJLabel.setText("Sayý düþük" );
                     SwingUtilities.updateComponentTreeUI(messageJLabel);
                     tahmin--;
             }
             if (Guess == number)
             {
            	 messageJLabel.setText("Doðru bildiniz!");
            	 SwingUtilities.updateComponentTreeUI(messageJLabel);
            	 getContentPane().setBackground(Color.GREEN);
            	 guessInputJTextField.setEditable(false);
            	 message2JLabel.setText("");}        
             if(tahmin==0){
            	 message2JLabel.setText("Hakkýnýz bitti. Yeni oyuna geçiniz."); 
            	 guessInputJTextField.setEditable(false);
            	 }
            	 ...
            	 message2JLabel.setText(tahmin + " hakkýnýz kaldý.");  
             }  
        }
    }
}